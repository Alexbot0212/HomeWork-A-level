...
// noswitch
{
    const noSwitch = (key, cases, defaultKey = 'default') => {
        if (key in cases) { //проверяем наличие введенного пользователем ключа из объекта
            cases[key]() //запускаем функцию, находящуюся в объекте по ключу из переменной drink
